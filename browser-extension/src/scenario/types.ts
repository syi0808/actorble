...
export type ScenarioCoordinateSpace = 'viewport' | 'document' | 'screen' | 'surface' | 'element';
...
export type ScenarioPointerButtonName = 'primary' | 'secondary' | 'auxiliary' | 'back' | 'forward';
